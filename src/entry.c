...
int __entry_menu(int argc, char **argv) {
	...
	OSScreenPutFontEx(0, 0, 0, "Hello World! This is nickthehacker.");
  OSScreenPutFontEx(0, 0, 2,  "my first wiiu homebrew app");

	//Print text to DRC (buffer 1)
	OSScreenPutFontEx(1, 0, 0, "Hello World! This is nickthehacker .");
	OSScreenPutFontEx(1, 0, 2, "my first wiiu homebrew app.");
	...
	VPADData vpad;
			...
			if(vpad.btns_h & VPAD_BUTTON_B){
       	OSScreenPutFontEx(0, 0, 1, "Well it worked button B.");
			}
